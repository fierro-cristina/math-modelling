    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'test']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                # statistics
                running_loss += loss.item() * inputs.size(0) #- 0.5
            ...
            print('{} Acc: {:.4f}'.format(phase, epoch_loss, epoch_acc))
...
#Model without intermediate layers 
...
#Model with all layers and fine tuning
